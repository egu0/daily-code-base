...
class NumOfSubarrays1343Test {
    ...
    void numOfSubarrays2() {
        int res = new NumOfSubarrays1343().numOfSubarrays(new int[]{11, 13, 17, 23, 29, 31, 7, 5, 2, 3}, 3, 5);
    ...
    void numOfSubarrays3() {
        ...
        int res = new NumOfSubarrays1343().numOfSubarrays(arr, 1, 307);
        Assertions.assertEquals(122, res);
    }
}