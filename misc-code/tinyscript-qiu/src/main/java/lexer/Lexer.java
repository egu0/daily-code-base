...
public class Lexer {
    ...
    public ArrayList<Token> analyse(@SuppressWarnings("rawtypes") Stream source) throws LexicalException {
     ...
     */
    public static ArrayList<Token> fromFile(String src)
            throws FileNotFoundException, UnsupportedEncodingException, LexicalException {
